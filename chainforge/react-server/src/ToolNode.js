...
import { IconTools, IconList } from '@tabler/icons-react';
...
const ToolNode = ({ data, id }) => {
  ...
  const handleRunClick = async (event) => {
    setInputOutputNodes();
    const hf = new HfInference("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"); // Optional: add your own API to avoid rate limiting

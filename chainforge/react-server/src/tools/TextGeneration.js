...
import { IconTools, IconList, IconWriting } from '@tabler/icons-react';
import { NativeSelect, Popover, Text, Tooltip, Center } from '@mantine/core';
...
const TextGeneration = ({ data, id }) => {
  ...
  return (
    <div className="cfnode">
      <NodeLabel title={data.title || 'Text Generation'}
        nodeId={id}
        icon={<IconWriting size="16px" />}
      ...
      />
        <div >
            <Text fz="sm" fw={500} c="#444" mt="xs">Prompt: </Text>
            <textarea
            rows="4"
            cols="40"
